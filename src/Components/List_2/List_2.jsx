import scss from "./List_2.module.scss";
    ...
    <section className={scss.List_2}>
      ...
      <div className={scss.contai_list}>
        {menu.map((item, index) => (
          <div
            key={index}
            className={`${scss.menu} ${openIndex === index ? scss.active : ""}`}
          >
            <div
